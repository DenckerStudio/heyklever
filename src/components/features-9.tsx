          ...
          <div>
            ...
            <div aria-hidden className="relative">
              <div className="absolute inset-0 z-10 m-auto size-fit">
                <div className="rounded-(--radius) bg-background z-1 dark:bg-muted relative flex size-fit w-fit items-center gap-2 border border-black/10 dark:border-white/10 px-3 py-1 text-xs font-medium shadow-md shadow-zinc-950/5">
          ...
          <div className="overflow-hidden border-t bg-zinc-50 p-6 sm:p-12 md:border-0 md:border-l border-black/10 dark:border-white/10 dark:bg-transparent">
            ...
            <div aria-hidden className="flex flex-col gap-8">
              <div>
                ...
                <div className="rounded-(--radius) bg-background mt-1.5 w-3/5 border border-black/10 dark:border-white/10 p-3 text-xs">
                  Hey, what's our company policy on remote work?
                </div>
              </div>

              <div>
                <div className="rounded-(--radius) mb-1 ml-auto w-3/5 bg-blue-600 p-3 text-xs text-white">
                  Our company policy on remote work is that we allow remote work
                  for all employees.
                </div>
