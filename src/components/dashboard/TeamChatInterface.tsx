...
export function TeamChatInterface({ teamId, teamName }: TeamChatInterfaceProps) {
    ...
    const handleSendMessage = async () => {
        ...
        startTransition(() => {
            ...
            setTimeout(async () => {
                try {
                    // Call the RAG webhook with private folder context
                    const response = await fetch('/api/rag/webhook', {
                        ...
                        body: JSON.stringify({
                            message: userMessage,
                            teamId,
                            context: 'private' // Search private folder for team members
                        }),
                    });
            ...
            >
              ...
              <div className="p-4">
                <Textarea
                  ...
                  placeholder={`Ask ${teamName} AI assistant a question...`}
              ...
              <div className="p-4 border-t border-slate-200 flex items-center justify-between gap-4 dark:border-slate-700">
                <div className="flex items-center gap-2 text-xs text-slate-500 dark:text-slate-400">
                  ...
                  Team AI Assistant - Private Access
                </div>
