...
import { MultiDirectionSlideText } from "./multi-direction-slide-text";
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="mx-auto mb-12 max-w-lg space-y-6 text-center">
            <h2 className="text-balance text-3xl font-semibold md:text-4xl">
              <MultiDirectionSlideText
                textLeft="Integrate with your"
                textRight="favorite tools"
                className=""
              />
            </h2>
          </div>
          <div className="group relative mx-auto max-w-[22rem] items-center justify-between space-y-6 [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] sm:max-w-md">
            ...
            <div className="absolute inset-0 m-auto flex size-fit justify-center gap-2">
              <IntegrationCard
                className="shadow-black-950/10 size-16 bg-white/75 dark:bg-black/75 shadow-xl backdrop-blur-md backdrop-grayscale dark:border-white/10 border-black/10 dark:shadow-white/15"
                isCenter={true}
              >
                <Image
                  src="/logo-icon.png"
