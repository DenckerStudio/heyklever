...
export function LetsWorkTogether() {
  ...
  return (
    <section className="flex min-h-content items-center justify-center px-6">
      <div className="relative flex flex-col items-center gap-12">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-widest uppercase text-muted-foreground">
            Become effective like never before
          </span>
        </div>
        ...
        >
          ...
          <p className="max-w-lg text-md leading-relaxed text-foreground tracking-widest">
            Start using{" "}
            <Highlighter action="underline" color="var(--primary)" isView iterations={3}>
              {" "}
              KleverAI{" "}
            </Highlighter>{" "}
            today, let's make life easier{" "}
            <Highlighter
              action="box"
              padding={5}
              color="var(--accent)"
