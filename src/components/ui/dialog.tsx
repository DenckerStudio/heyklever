        ...
        <DialogPortal forceMount data-slot="dialog-portal">
          ...
          <DialogPrimitive.Content asChild forceMount {...props}>
            <motion.div
              ...
              className={cn(
                "bg-background text-foreground fixed top-[50%] left-[50%] z-50 grid w-[calc(100%-2rem)] max-w-lg translate-x-[-50%] translate-y-[-50%] gap-4 rounded-xl border border-border p-4 shadow-lg",
                className,
              )}
              transition={
